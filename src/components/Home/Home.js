      ...
      <div id="home">
        ...
        <HeaderHome title={"milk mama"} artcat={"ARTICLE CAT"} />
          <div className="page-body">
            ...
            {/* <div className="home-article-previews"> */}
            <ArticlePreviewHome 
            ...
            />
              ...
              <NavLink exact activeClassName="" to="/about">
                <div className="more-article">
                  <img className="more-img" alt="img" src="https://images.unsplash.com/photo-1458071103673-6a6e4c4a3413?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80" />
                  <div className="more-title">
                  <p className="cnt-reading">about lauren</p>
